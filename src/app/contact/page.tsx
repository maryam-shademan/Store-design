...
function contact() {
  return (
    <>
      ...
      <div className="container mx-auto  py-8 bg-white mt-6">
       ...
       Z"
            ...
            <div className="mx-2.5 overflow-hidden w-full">
              <p className="mt-1.5 text-xl font-bold text-emerald-700 leading-8 mr-3 overflow-hidden text-ellipsis whitespace-nowrap">
                آدرس ما
              </p>
  ...
  <section className="text-emerald-900 body-font relative">
    <div className="container px-5 py-24 mx-auto flex sm:flex-nowrap flex-wrap">
      <div className="lg:w-2/3 md:w-1/2 bg-gray-300 rounded-lg overflow-hidden sm:mr-10 p-10 flex items-end justify-start relative">
        ...
        <div className="bg-white relative flex flex-wrap py-6 rounded shadow-md">
          <div className="lg:w-1/2 px-6">
            <h2 className="title-font font-semibold text-emerald-700 tracking-widest text-xs">
              آدرس
            </h2>
            <p className="mt-1">
          ...
          <div className="lg:w-1/2 px-6 mt-4 lg:mt-0">
            ...
            <h2 className="title-font font-semibold text-emerald-700 tracking-widest text-xs mt-4">
              شماره
            </h2>
      ...
      <div className="lg:w-1/3 md:w-1/2 bg-white flex flex-col md:ml-auto w-full md:py-8 mt-8 md:mt-0">
        <h2 className="text-emerald-700 text-lg mb-1 font-medium title-font text-center">
          نظرات ویااگر سوالی دارید فرم را پرکنید
        </h2>
        <p className="leading-relaxed mb-5 text-emerald-950 text-center">
          در سریع ترین زمان متخصصین جواب میدهند
        </p>
        <div className="relative mb-4">
          <label htmlFor="name" className="leading-7 text-sm text-emerald-900">
            نام و نام خانوادگی
          </label>
          <input
            type="text"
        ...
        <div className="relative mb-4">
          <label htmlFor="email" className="leading-7 text-sm text-emerald-900">
            ایمیل
          </label>
          <input
            type="email"
        ...
        <div className="relative mb-4">
          <label htmlFor="message" className="leading-7 text-sm text-emerald-900">
            پیام
          </label>
          <textarea
            id="message"
        ...
        <button className="text-white bg-[#F5D6B0] border-0 py-2 px-6 focus:outline-none hover:bg-[#f8c88d]  rounded text-lg">
          ثبت
        </button>
